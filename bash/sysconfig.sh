...
echo "There is some error message" 2>/COMP2101/bash/stderr
return
}
...
function error-exit {
echo "Here some text to print to stderr" 2>/COMP2101/bash/stderr
echo "EXIT" >&2
return
...
function cleanup {
  rm /tmp/*.$$
  echo "All tmp files have been removed created by this script"
  exit
}
